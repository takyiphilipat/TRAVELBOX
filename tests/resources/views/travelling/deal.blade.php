...
<div class="search-form">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form id="search-form" name="gs" method="POST" role="search" action="{{ route('travelling.searchdeals') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-2">
                            <h4>Sort Deals By:</h4>
                        ...
                        <div class="col-lg-4">
                            <fieldset>
                                <select name="country_id" class="form-select" id="chooseLocation" onChange="this.form.submit()">
                        ...
                        <div class="col-lg-4">
                            <fieldset>
                                <select name="price" class="form-select" id="choosePrice" onChange="this.form.submit()">
